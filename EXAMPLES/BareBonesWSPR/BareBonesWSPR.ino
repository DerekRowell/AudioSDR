...
void setup() {
  ...
  Tuner.reset();                                                                //*
  delay(20);                                                                    //*
  //  SI5351 xtal correction using WSJT-X and WWV at 10 Mz (8/20/19)            //*
  //  (Sets frequency to within 0.3 Hz at 10 MHz (0.03 ppm))                    //*
  Tuner.Correction(10000000.0, 10000113.0);                                     //*    
  ...
  //
  SDR.enableAGC();                // There's a bit of debate whether AGC should be on
